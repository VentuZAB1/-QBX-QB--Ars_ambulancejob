...
local function isEmsVehicle(vehicle)
    -- Validate entity exists and is a vehicle
...
local function vehicleInteractions()
    local options = {
        ...
        },
        {
            ...
            fn = function(data)
                if not data.entity or not DoesEntityExist(data.entity) then return end
        ...
        },
        {
            ...
            groups = Config.EmsJobs,
            cn = function(entity, distance, coords, name)
                return isEmsVehicle(entity) and entity and DoesEntityExist(entity) and Entity(entity).state?.patient
            end,
            fn = function(data)
                if not data.entity or not DoesEntityExist(data.entity) then return end
